...
#this dalmatian image was not matched properly
#image = cv2.imread('Assignment 10/dalmatians.webp')
#this poster image seemed to work properly
image = cv2.imread('Assignment 10/taxiDriver.png')
...
#cv2.imwrite('dalmatianTorch.png',image)
cv2.imwrite('taxiDriverTorch.png',image)
