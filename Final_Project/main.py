...
if __name__ == "__main__":
    ...
    gap = float(input("Write fineness of sound discerning such as 0.01(hz): "))
    inst = Instrument(source,fineness=gap)
    note = inst.note(second=5,amplitude=0.1,precision=1000)
    ...
    audioFile.export(f"models/{output_path}", format="mp3")
